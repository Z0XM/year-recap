	...
	return (
		<div className='flex flex-col w-screen items-center justify-center gap-4 px-4 py-2 md:px-6 md:py-4'>
			<div className='w-full flex flex-col gap-2'>
				<Label className='text-xl text-green-400'>Basics</Label>
				<div className='w-full'>
					<Accordion className='w-full' type='multiple'>
						<AccordionItem value='1'>
							<AccordionTrigger>What is this website About ? </AccordionTrigger>
							<AccordionContent>
								You login. Fill a form about your day, about your week on weekends, and about your month on month ends.
								We collect this data and plan to make a beautiful digital or physical recap of your weeks, months and
								finally, the whole year.
							</AccordionContent>
						</AccordionItem>
						...
						<AccordionItem value='3'>
							...
							<AccordionContent>
								The data collected via your forms will be stored, analyzed and aggregated by Mathematics (not AI). We
								work with your data to present it in various modes for you to feel amazed by it.
							</AccordionContent>
						</AccordionItem>
					</Accordion>
				</div>
			...
			<div className='w-full flex flex-col gap-2'>
				<Label className='text-xl text-green-400'>FAQs</Label>
				<div className='w-full'>
					<Accordion className='w-full' type='multiple'>
						<AccordionItem value='1'>
						...
						<AccordionItem value='2'>
							...
							<AccordionContent>
								The design of this project is such that missing data can be adjusted by using several different
								modelling techniques. Still, they would have limitations. They more data you provide, the better
								experience we can curate for you.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem value='3'>
						...
						<AccordionItem value='4'>
							...
							<AccordionContent>
								Currently, you cannot. In future we will plan to allow visualizations but not complete data to have a
								better effect on personal experiences
							</AccordionContent>
						</AccordionItem>
					</Accordion>
				</div>
			...
			<div className='w-full flex flex-col gap-2'>
				<Label className='text-xl text-green-400'>Philosophy</Label>
				<div className='w-full'>
					<Accordion className='w-full' type='multiple'>
						<AccordionItem value='1'>
							<AccordionTrigger>Why should you bother ? </AccordionTrigger>
							<AccordionContent>
								Basic idea of this project is to make it very easy and seamless for people to *express* their emotions
								and daily shenanigans. This is a very basic form of journalism. We believe that this will help people to
								inspect their lives and make better decisions by reflecting back on their days while it being very easy
								for them to do so. And also, it is fun to see how your year went and store it as a digital or physical
								memory .
							</AccordionContent>
						</AccordionItem>
						<AccordionItem value='2'>
							...
							<AccordionContent>
								A lot of times people feel vastly complex emotions which are very true to them. But in a co-living
								society we often fail to acknowledge that the people around us could also be going through similar or
								complex emotions, bad days, inexpressible feelings and much more. We aim to build a platform where
								through visualizations of data people can see, feel and express along with others.
							</AccordionContent>
						</AccordionItem>
					</Accordion>
				</div>
			...
			{/* <div className='w-full flex flex-col gap-2'>
				<Label className='text-xl text-green-400'>Future Plans</Label>
				<div className='w-full'>
					<Accordion className='w-full' type='multiple'>
						<AccordionItem value='1'>
							<AccordionTrigger>What is this website About ? </AccordionTrigger>
			...
			<div className='w-full flex flex-col gap-2'>
				<Label className='text-xl text-green-400'>Who are we?</Label>
				<div className='w-full'>
					<Accordion className='w-full' type='multiple'>
						<AccordionItem value='1'>
